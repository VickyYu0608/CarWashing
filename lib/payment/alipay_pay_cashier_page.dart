...
/// In-app cashier that mirrors Alipay's amount + password screen.
class AlipayPayCashierPage extends StatefulWidget {
  const AlipayPayCashierPage({
  ...
  @override
  State<AlipayPayCashierPage> createState() => _AlipayPayCashierPageState();
}

class _AlipayPayCashierPageState extends State<AlipayPayCashierPage> {
  static const _alipayBlue = Color(0xff1677ff);
            ...
            child: ListView(
              ...
              children: [
                ...
                if (_submitting) ...[
                  ...
                  const Center(
                    child: CircularProgressIndicator(color: _alipayBlue),
                  ),
                ],
              ],
            ),
